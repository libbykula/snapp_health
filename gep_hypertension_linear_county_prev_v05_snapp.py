...
def get_hypertension_gep(c, perc_adults, scen):
    # Save results to CSV
    output_dir = os.path.join(dir, 'gep_health/output/linear_county_prev_6_16_26_' + scen)
    os.makedirs(output_dir, exist_ok=True)

    ndvi_path = os.path.join(base_dir, 'NDVI/ndvi_2019_ave_scaled_' + scen + '_' + c + '.tiff')
