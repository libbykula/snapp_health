...
import gep_hypertension_linear_county_prev_v05
import os
...
for county_geoid in county_geoids:
    print("running", country_label, county_geoid)
    try:
        gep_hypertension_linear_county_prev_v05.get_hypertension_gep(county_geoid, perc_adults)
    except Exception as e:
        print("FAILED", country_label, county_geoid, e)
